...
def main(request):
    ...
    # Slider
    s = Slider.objects.filter(Q(blog__company='all') | Q(blog__company='miradent'))
    # End Slider
    ...
    response = render(request, 'main/miradent/index.html', {'first':first, 'second':second, 'third':third, 's':s})

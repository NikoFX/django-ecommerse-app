...
def main(request):
    ...
    # Slider
    s = Slider.objects.filter(Q(blog__company='all') | Q(blog__company='bilimplant'))
    # End Slider
    ...
    response = render(request, 'main/bilimplant/index.html', {'first':first, 'second':second, 'third':third, 's':s})
    ...
    if request.POST:
        ...
        messages.success(request, 'We will contact you soon as possible. Thank you!')

...
def basket(request):
    ...
    if r==0:
        ...
        return render(request, 'basket/bilimplant/basket.html', {'bt': bt, 'cookie_id':cookie_id, 'price':price})
...
def checkout(request):
    ...
    if request.POST:
        ...
        return redirect('/bilimplant/products/')

    return render(request, 'basket/bilimplant/checkout.html', )
...
def basket(request):
    ...
    if r==0:
        ...
        return render(request, 'basket/tepe/basket.html', {'bt': bt, 'cookie_id':cookie_id, 'price':price})
...
def checkout(request):
    ...
    if request.POST:
        ...
        return redirect('/tepe/products/')

    return render(request, 'basket/tepe/checkout.html', )